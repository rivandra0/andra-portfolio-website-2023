<template>
  <q-page padding>
    <section class="row justify-start items-start text-left q-pa-xl" style="height:85vh">
      <div class="col-xs-11 col-sm-6 col-md-6 q-mr-xl">
        <div class="text-h1 q-mb-md">
          About Me
        </div>
        <div class="text-p q-mb-md q-py-md q-pr-sm">
          <div class="text-bold">I just got my Bachelor degree in <strong>Industrial Engineering from Andalas University</strong> in March 2023, and I've been learning <strong>web development</strong> since late 2020.</div>
          <br>
        ...
        <a href=""><q-btn outline color="positive" icon="download" label="Download CV"/></a>
      </div>
      <div class="col-4 items-center gt-xs">
        <q-img
          ...
          bordered
        >
        <div class="bg-green-7 absolute-bottom-right text-subtitle2">
          Muhammad Rivandra
        </div>
      </q-img>
      </div>
